-- Dumping structure for table store_category
CREATE TABLE IF NOT EXISTS `store_category` (
  `id` int unsigned NOT NULL DEFAULT '0',
  `parentId` int unsigned NOT NULL DEFAULT '26',
...
-- Dumping data for table store_category: ~35 rows (approximately)
REPLACE INTO `store_category` (`id`, `parentId`, `name`, `description`, `index`, `visible`) VALUES
...
-- Dumping structure for table store_offer_group
CREATE TABLE IF NOT EXISTS `store_offer_group` (
  `id` int unsigned NOT NULL DEFAULT '0',
  `displayFlags` int unsigned NOT NULL DEFAULT '0',
  `name` varchar(50) NOT NULL DEFAULT '',
  `description` varchar(500) NOT NULL DEFAULT '',
  `displayInfoOverride` smallint unsigned NOT NULL DEFAULT '0',
  `visible` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table store_offer_group: ~350 rows (approximately)
...
-- Dumping structure for table store_offer_group_category
...
-- Dumping data for table store_offer_group_category: ~748 rows (approximately)
...
-- Dumping structure for table store_offer_item
CREATE TABLE IF NOT EXISTS `store_offer_item` (
  ...
  UNIQUE KEY `AK_store_offer_item_id` (`id`),
  UNIQUE KEY `id` (`id`),
...
-- Dumping data for table store_offer_item: ~480 rows (approximately)
...
-- Dumping structure for table store_offer_item_data
...
-- Dumping data for table store_offer_item_data: ~1,303 rows (approximately)
...
-- Dumping structure for table store_offer_item_price
CREATE TABLE IF NOT EXISTS `store_offer_item_price` (
  `id` int unsigned NOT NULL DEFAULT '0',
  `currencyId` tinyint unsigned NOT NULL DEFAULT '0',
  `price` float NOT NULL DEFAULT '0',
  `discountType` tinyint unsigned NOT NULL DEFAULT '0',
  `discountValue` float NOT NULL DEFAULT '0',
  `field_14` bigint NOT NULL DEFAULT '0',
...
-- Dumping data for table store_offer_item_price: ~959 rows (approximately)
